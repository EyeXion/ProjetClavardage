...
public class DataBaseAccess {
    ...
    private DataBaseAccess(String addr, String user, String mdp, String nomBdd) {
        try {
        ...
        try {
            String urlBdd = "jdbc:mysql://" + addr + ":3306/" + nomBdd + "?useSSL=false";
     ...
     */
    public static DataBaseAccess getInstance(String addr, String user, String mdp, String nomBdd) {
        synchronized (DataBaseAccess.class) {
            if (instance == null) {
                instance = new DataBaseAccess(addr, user, mdp, nomBdd);
            }
            return instance;
        }
    }
